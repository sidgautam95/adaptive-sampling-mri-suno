...
img_recon_train_path = 'train-img-aliased/'
img_recon_test_path = 'test-img-aliased/'
...
for metric in metrics:
    ...
    for test_idx in range(nTest): # iterative over test set
        ...
        np.save('pred_icd_mask_'+filename[17:],pred_icd_mask[0]) 
        np.save('pred_nearest_neighbor_'+filename[17:],pred_nearest_neighbor) 
