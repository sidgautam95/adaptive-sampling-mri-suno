...
def icd_sampling_optimization(ksp, mps, img_gt, initial_mask, budget, num_centre_lines, model, device, num_icd_passes=1, nChannels=2, \
                             recon='unet', alpha1=1, alpha2=0, alpha3=0, alpha4=0, print_loss=False, save_recon=False, num_modl_iter=6):
    ...
    print('Running ICD sampling optimization algorithm algorithm')
